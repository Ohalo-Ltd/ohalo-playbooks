...
def test_metadata_store_writes_rows():
    ...
    record = MetadataRecord(
        ...
        sha256=None,
        sha256_file_meta=None,
        doc_language="en",
        composite_type=None,
        is_processed=True,
        document_status="INDEXED",
        text_extraction_status=None,
        metadata_extraction_status=None,
        dxr_tags=["Confidential"],
        removed_tags=[],
        ocr_used=None,
        ai_category=None,
        ai_category_last_updated=None,
        annotation_stats_json=None,
        annotations_json=None,
        metadata_fields_json=None,
        metadata_fields_map={},
        extracted_metadata_json=None,
        extracted_metadata_map={},
